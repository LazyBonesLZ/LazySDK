...
public final class LoadTextTask implements Runnable {

    private final static String TAG = "LoadTextTask";
    private static LoadTextTask __object;
     ...
     */
    public static LoadTextTask get(Context context) {
        if (__object == null) {
           __object = new LoadTextTask(context);
        }
        return __object;
    }
     ...
     * @param context Android context
     */
    private LoadTextTask(Context context) {
...
//                       R.drawable.p9_1080, R.drawable.p10_1080}p10_1080
        };
    }
