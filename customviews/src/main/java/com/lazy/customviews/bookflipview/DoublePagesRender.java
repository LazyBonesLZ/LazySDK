 ...
 */
package com.lazy.customviews.bookflipview;
...
import com.lazy.customviews.bookflipview.baselib.Page;
import com.lazy.customviews.bookflipview.baselib.PageFlip;
import com.lazy.customviews.bookflipview.baselib.PageFlipState;
...
//        LoadBitmapTask.get(mContext).set(pageW, pageH, 2);
    ...
    private void drawPage(int number) {
        ...
        Bitmap background = /*LoadBitmapTask.get(mContext).getBitmap();*/
                BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.guide1_bg_1);
//                ResourcesCompat.getDrawable(mContext.getResources(), R.mipmap.guide1_bg_1,null)
